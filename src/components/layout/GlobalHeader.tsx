                ...
                {store.navigation.map((navItem) => (
                  <div key={navItem.id} className="relative group">
                    ...
                    {navItem.subItems && navItem.subItems.length > 0 && (
                      <div className="absolute top-[calc(100%-8px)] left-0 w-64 bg-white dark:bg-slate-800 shadow-xl border border-slate-100 dark:border-slate-700 rounded-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all translate-y-2 group-hover:translate-y-0 z-50 p-2">
